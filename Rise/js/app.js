(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-big")) new swiper_core_Swiper(".swiper-big", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                prevEl: ".swiper-button-prev",
                nextEl: ".swiper-button-next",
                disabledClass: "swiper-button-disabl"
            },
            watchOverflow: true,
            updateOnWindowResize: true,
            resistanceRatio: 0,
        ...
        if (document.querySelector(".swiper-clients")) new swiper_core_Swiper(".swiper-clients", {
            modules: [ Pagination ],
            centeredSlides: true,
            initialSlide: 1,
            speed: 800,
