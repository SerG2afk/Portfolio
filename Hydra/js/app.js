(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swiper-build")) new swiper_core_Swiper(".swiper-build", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".swiper-button-br-prev",
                nextEl: ".swiper-button-br-next"
            },
            breakpoints: {
                200: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-partnes")) new swiper_core_Swiper(".swiper-partnes", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".swiper-how")) new swiper_core_Swiper(".swiper-how", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
